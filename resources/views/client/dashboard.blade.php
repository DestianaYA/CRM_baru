...
<body id="page-top">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <h6 class="dropdown-header justify-content-center">
                                    ...
                                    <form action="{{ route('topups.store') }}" method="POST">
                                        ...
                                        <button type="submit" class="btn btn-topup justify-content-center"onclick="payWithMidtrans()">Top
                                            Up</button>
                                    </form>
                                </body>
                                <!-- Dropdown - Messages -->
                                ...
                                <div class="card border-left-primary shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div id="greeting-container" class="h5 mb-0 font-weight-bold text-gray-800">
                    ...
                    <div class="card-container">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                <h6 class="m-0 font-weight-bold text-primary">Notif</h6>
                            ...
                            <div class="card-body">
                                <pre>{{ $roleContent->notif ?? 'No notifications available.' }}</pre>
                            </div>
                        </div>

                        <div class="card shadow mb-4">
                            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                <h6 class="m-0 font-weight-bold text-primary">S&K</h6>
                                <div class="dropdown no-arrow">
                                    <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink"
                                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <i class="fa-sm fa-fw text-gray-400"></i>
                            ...
                            <div class="card-body">
                                <pre>{{ $roleContent->sk ?? 'No terms and conditions available.' }}</pre>
                            </div>
                        </div>
                    </div>
                <!-- End of Main Content -->
    ...
    <!-- greetings -->
    <script src="{{ asset('assets/js/greetings.js') }}"></script>
    <script src="{{ asset('assets/js/midtrans.js') }}"></script>
