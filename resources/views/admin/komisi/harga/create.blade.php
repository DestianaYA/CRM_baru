        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="container-fluid">
                            <body>
                                <div class="body-kategori container mt-5">
                                    <div class="row">
                                        <div class="col-md-6 offset-md-3">
                                        @if (session('success'))
                                        <div id="success-alert" style="color: green;">
                                            {{ session('success') }}
                                        </div>

                                        <script>
                                            // Menggunakan JavaScript untuk menghapus elemen setelah 5 detik
                                            setTimeout(function() {
                                        ...
                                        @endif
                                        <form action="{{ route('komisi.harga.update') }}" method="POST">
                                            @csrf
                                            @method('PATCH')
                                            <label for="harga">Harga</label>
                                            <input type="integer" name="harga" id="harga">
                                            <p></p>
