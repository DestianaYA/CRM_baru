            ...
            <div id="content">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    ...
                                    src="{{ Auth::user()->photo_image ? asset('storage/' . Auth::user()->photo_image) : asset('assets/storage/profile_images') }}">
                            </a>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                           <form action="{{ route('admin.komisi.kategori.update', ['kategori' => $kategori->id]) }}" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="fee" name="fee" step="0.01" value="{{ $kategori->fee }}" required>
                                </div>
                                <div class="form-group">
                                    <label for="jumlah_anggota">Jumlah Anggota</label>
                                    <input type="number" class="form-control" id="jumlah_anggota" name="jumlah_anggota" value="{{ $kategori->jumlah_anggota }}" required>
                                </div>
                                <div class="form-group">
                                    <a href="{{ route('admin.komisi.kategori.index') }}" class="btn btn-secondary">Kembali</a>
